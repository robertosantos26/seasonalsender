...
def get_config():
    ...
    return {
        ...
        "cv_agricultural":    file_cfg.get("cv_agricultural") or os.environ.get("CV_AGRI", "Roberto Resume - H2A.pdf"),
        "cv_non_agricultural":file_cfg.get("cv_non_agricultural") or os.environ.get("CV_NON_AGRI", "Roberto Resume.pdf"),
        "cover_letter_agricultural": file_cfg.get("cover_letter_agricultural") or os.environ.get("COVER_LETTER_AGRI", "Roberto Cover_letter_H2A.pdf"),
        "cover_letter_non_agricultural": file_cfg.get("cover_letter_non_agricultural") or os.environ.get("COVER_LETTER_NON_AGRI", "Roberto Cover_letter.pdf"),
